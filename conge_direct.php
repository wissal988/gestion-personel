                ...
                if ($result444 && mysqli_num_rows($result444) > 0) {
                    while ($row444 = mysqli_fetch_assoc($result444)) {
                        ...
                        if ($result4444) {
                            ...
                            <table class="table-container">
                                ...
                                <tbody style="background-color: white;">
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($row4['val_direction'] == "0") {
                                                ?>
                                                <form action="conge_direct.php" method="post">
                            ...
                            <?php
                               }else if ($row4['type_conge'] == 'exeption' && $row4['val_departement'] == '1' && $row4['val_direction'] == '0') {
                                ?>
                                <h2> Demandes des congés de recuperation</h2>
                                <table class="table-container">
                                    <thead>
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        if ($selectedOption == 'oui') {
            ...
            $query = "UPDATE demande_conge SET val_directiont = 2 WHERE id_demande = ?";
        }
