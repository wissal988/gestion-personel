        ...
        if ($result44 && mysqli_num_rows($result44) > 0) {
            while ($row44 = mysqli_fetch_assoc($result44)) {
                ...
                while ($row444 = mysqli_fetch_assoc($result444)) {
                    if ($row444['nom_departement'] == $_SESSION['approbation']) {
                        if ($row4['type_conge'] == 'annuel detente' && $row4['val_departement'] == '0') {
                            ?>
                            ...
                            <table class="table-container">
                                ...
                                <tbody style="background-color: white;">
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($row4['val_departement'] == "0") {
                                                ?>
                                                <form action="conge_depar.php" method="post">
                            ...
                            <?php
                        } else if ($row4['type_conge'] == 'recuperation' && $row4['val_departement'] == '0') {
                            ?>
                            ...
                            <?php
                        } else if ($row4['type_conge'] == 'exeption' && $row4['val_departement'] == '0') {
                            ?>
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        if ($selectedOption == 'oui') {
            $query = "UPDATE demande_conge SET val_departement = 1 WHERE id_demande = ?";
        } elseif ($selectedOption == 'non') {
            $query = "UPDATE demande_conge SET val_departement = 2 WHERE id_demande = ?";
        }
    ...
    if ($resultat44 && mysqli_num_rows($resultat44) > 0) {
        while ($line44 = mysqli_fetch_assoc($resultat44)) {
            ...
            while ($line444 = mysqli_fetch_assoc($resultat444)) {
                if ($line444['nom_departement'] == $_SESSION['approbation']) {
                    
                     if ( $line4['val_departement'] == '1'  ) {  
?>
                    <tr>
                        ...
                        <?php if ($line4['val_direction'] == '0') { ?>
                            <td>Direction</td>
                            <td>En attente</td> 
                        <?php } else if ($line4['val_direction'] == '2') { ?>
                            <td>Direction</td>
                            <td>Refuse</td> 
                        <?php } else if ($line4['val_direction'] == '1' && $line4['val1_rh'] == '0' ) { ?> 
                            <td>Ressources humaines</td>
                            <td>En attente</td>  
                        <?php } else if ($line4['val_direction'] == '1' && $line4['val1_rh'] == '2' ) { ?> 
                            <td>Ressources humaines</td>
                            <td>Refuse</td>   
